...
- (QueryResult*) execute: (NSString*) query 
		withDefaultDatabase: (NSString*) database; 
- (QueryResult*) execute: (NSString*) query 
		withDefaultDatabase: (NSString*) database 
			logOutOnException: (bool)logOutOnException;

- (void) executeQueries: (NSString*) query;

- (BOOL) executeInBackground: (NSString*) query 
								withDatabase: (NSString*) database 
							returnToObject: (id) receiver 
